        ...
        <section>
            ...
            >
                ...
                <div className="relative">
                    ...
                    <h1 className="text-xl sm:text-4xl front-bold tracking-light text-primary-100">
                    ...
                    <p className="mt-3 sm:mt-6 text-md sm:text-xl text-gray-300 leading-8">
                    ...
                    <div className="flex mt-4 sm:mt-8 gap-4 sm:gap-6">
                        <AboutSection />
                        <ContactSection />
                    </div>
                </div>
