            ...
            <div 
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    <div className="space-y-4 md:w-1/2">
                        ...
                        <div>
                            <h3 className="font-semibold text-xl mb-2 text-primary-500 underline decoration-gray-600">
                                Tech Stack:</h3>
                    ...
                    <div className="absolute inset-x-2/5 -bottom-1/3">
                        <a 
                            href={project.link} 
                            className="inline-block mt-4 px-2 py-1 bg-primary text-white rounded-md hover:bg-primary-500/50 hover:text-primary-200 text-center">
                                View Project</a>
                    </div>
                    </div>
                    <div className="absolute top-1/2 -translate-y-1/2 flex justify-between w-11/12 max-w-4xl">
                        <button 
                            onClick={onPrev} 
                            className="bg-gray-800/50 rounded-full p-2 hover:text-primary-400 hover:bg-gray-800/70 transition-colors -translate-x-[125%]">
                            <ChevronLeft size={24} />
                        </button>
                        <button 
                            onClick={onNext} 
